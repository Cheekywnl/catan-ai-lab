...
function overview() {
  return `${heading("THE RESEARCH WORKSPACE", "A smarter way to play.", "The blueprint for a Catan engine that remembers, reasons, and learns.", "Engine 0.1 · Playable")}
