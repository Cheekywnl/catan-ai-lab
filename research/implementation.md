...
**Current status: paused by the user on 12 September 2026 at 02:01 UTC.** The automation and all tournament workers are stopped. Engine 0.4.0 is unchanged. The secondary Tactical-v4 batches completed with 223/800 wins against v2 (interval 26–29.75%) and 205/400 against v1 (46.25–56%), with no errors/truncations. The budget-48 search trial is saved at 62/100 games and is not a final strength result. See the [progress report, raw results and portable resume checkpoint](progress-2026-09-12.md). Entries below describe earlier release stages.
