...
- Browser validation:22 passed,2 intended mobile skips;6 content checks passed. Engine 0.3.1 budget12 completed100 games with21 wins and0errors/truncations; matched Tactical control had26wins. Paired whole-board bootstrap difference is−5 percentage points, interval−13 to+3. This is not evidence of stronger search. Report `search12-v031-comparison.json`. Keep search experimental; the budget48 arm continues unchanged.
- Next fixed protocol before outcomes: engine 0.3.2 budget12 versus three strategic-v2 opponents,100games on fresh seeds 6200–6224/all4seats, tracking on,horizon 1600,max initial candidates4,maxactions4000. Four workers. Matched Tactical control on exactly those boards/settings,100games,two workers. Directories `../../work/experiments/search12-v032-6200` and `../../work/experiments/tactical-control-v032-6200`. These use the new sampler, so keep their evidence separate from0.3.1. Record runtime, sampler rejections and all failures; compare only after complete outcomes.
